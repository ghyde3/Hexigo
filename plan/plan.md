...
- ✅ End game functionality with player stats modal and new game button
...
- ✅ Add end game functionality with player stats modal
- ✅ Implement new game button to reset the game
